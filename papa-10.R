...
log_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Station_Papa/Station_Papa-10_SKQ202308S_2023-05-13/Water_Sampling/Station_Papa-10_SKQ202308S_CTD_Sampling_Log_2023-08-23_Ver_1-00.xlsx')

# Papa 10 salinity data Version 1-00 
sal_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Station_Papa/Station_Papa-10_SKQ202308S_2023-05-13/Water_Sampling/Station_Papa-10_SKQ202308S_Salinity_Sample_Data_2023-08-23_Ver_1-00.xlsx')
