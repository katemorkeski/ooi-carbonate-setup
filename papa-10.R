...
# Papa 10 Sampling Log Version 1-00
log_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Global%20Station%20Papa%20Array/Cruise%20Data/Station_Papa-10_SKQ20230513_2023-05-13/Ship%20Data/Water%20Sampling/Station_Papa-10_SKQ202308S_CTD_Sampling_Log_2023-08-23_Ver_1-00.xlsx')

# Papa 10 salinity data Version 1-00 
sal_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Global%20Station%20Papa%20Array/Cruise%20Data/Station_Papa-10_SKQ20230513_2023-05-13/Ship%20Data/Water%20Sampling/Station_Papa-10_SKQ202308S_Salinity_Sample_Data_2023-08-23_Ver_1-00.xlsx')
...
write_csv(bottles_sal, "Papa_10_carbonate_bottle_salinity.csv")
