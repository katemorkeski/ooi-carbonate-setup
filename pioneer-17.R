...
#log_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Coastal%20Pioneer%20NES%20Array/Cruise%20Data/Pioneer-17_AR61_2021-10-26/Ship%20Data/Water%20Sampling/Pioneer-17_AR61A_CTD_Sampling_Log_2022-10-07_Ver_1-01.xlsx')
log_url <-('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-17_AR61_2021-10-26/Water_Sampling/Pioneer-17_AR61A_CTD_Sampling_Log_2022-10-07_Ver_1-01.xlsx')

# salinity data Leg A Version 1-00  (--> adjust to new repository)
#sal_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Coastal%20Pioneer%20NES%20Array/Cruise%20Data/Pioneer-17_AR61_2021-10-26/Ship%20Data/Water%20Sampling/Pioneer-17_AR61A_Salinity_Sample_Data_2021-12-08_Ver_1-00.xlsx')
sal_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-17_AR61_2021-10-26/Water_Sampling/Pioneer-17_AR61A_Salinity_Sample_Data_2021-12-08_Ver_1-00.xlsx')

# Supply credentials for Alfresco  --> not needed in new repository
#creds <- read_file("authenticate.txt")

#httr::GET(log_url, authenticate(creds, creds), write_disk(logtf <- tempfile(fileext = ".xlsx")))  --> old
httr::GET(log_url, write_disk(logtf <- tempfile(fileext = ".xlsx")))

logtf

#httr::GET(sal_url, authenticate(creds, creds), write_disk(saltf <- tempfile(fileext = ".xlsx")))  --> old
...
#log_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Coastal%20Pioneer%20NES%20Array/Cruise%20Data/Pioneer-17_AR61_2021-10-26/Ship%20Data/Water%20Sampling/Pioneer-17_AR61B_CTD_Sampling_Log_2022-02-03_Ver_1-01.xlsx')
log_url <-('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-17_AR61_2021-10-26/Water_Sampling/Pioneer-17_AR61B_CTD_Sampling_Log_2022-02-03_Ver_1-01.xlsx')
 
# salinity data Leg B Version 1-00  (--> adjust to new repository)
#sal_url <- ('https://alfresco.oceanobservatories.org/alfresco/webdav/OOI/Coastal%20Pioneer%20NES%20Array/Cruise%20Data/Pioneer-17_AR61_2021-10-26/Ship%20Data/Water%20Sampling/Pioneer-17_AR61B_Salinity_Sample_Data_2021-12-08_Ver_1-00.xlsx')
sal_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-17_AR61_2021-10-26/Water_Sampling/Pioneer-17_AR61B_Salinity_Sample_Data_2021-12-08_Ver_1-00.xlsx')
