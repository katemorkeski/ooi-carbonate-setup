...
# Irminger 8 Sampling Log Version 1-02
#log_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Irminger_Sea/Irminger_Sea-08_AR60-01_2021-08-03/Water_Sampling/Irminger_Sea-08_AR60-01_Discrete_Summary.csv')
log_url <-("https://rawdata.oceanobservatories.org/files/cruise_data/Irminger_Sea/Irminger_Sea-08_AR60-01_2021-08-03/Water_Sampling/Irminger_Sea-08_AR60-01_CTD_Sampling_Log_2024-01-24_Ver_1-02.xlsx")   

# Irminger 8 salinity data Version 1-00
sal_url <- ("https://rawdata.oceanobservatories.org/files/cruise_data/Irminger_Sea/Irminger_Sea-08_AR60-01_2021-08-03/Water_Sampling/Irminger_Sea-08_AR60-01_Salinity_Sample_Data_2021-09-02_Ver_1-00.xlsx")
