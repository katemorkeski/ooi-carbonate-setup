...
# Pioneer 16 Sampling Log Leg A Version 1-00  (--> adjust to new repository)
...
log_url <-('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-16_AR52_2021-03-29/Water_Sampling/Pioneer-16_AR52A_CTD_Sampling_Log_2022-10-21_Ver_1-01.xlsx')

# Pioneer 16 salinity data Leg A Version 1-00  (--> adjust to new repository)
...
sal_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-16_AR52_2021-03-29/Water_Sampling/Pioneer-16_AR52A_Salinity_Sample_Data_2024-08-29_Ver_1-01.xlsx')
...
# Pioneer 16 Sampling Log Leg B Version 1-01  (--> adjust to new repository)
...
log_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-16_AR52_2021-03-29/Water_Sampling/Pioneer-16_AR52B_CTD_Sampling_Log_2021-04-21_Ver_1-00.xlsx')

# Pioneer 16 salinity data Leg B Version 1-00  (--> adjust to new repository)
...
sal_url <- ('https://rawdata.oceanobservatories.org/files/cruise_data/Pioneer-NES/Pioneer-16_AR52_2021-03-29/Water_Sampling/Pioneer-16_AR52B_Salinity_Sample_Data_2021-05-03_Ver_1-00.xlsx')
...
# write salinity dataframe to csv  --> uncomment for saving
...
write_csv(bottles_sal_16, "Pioneer_16_carbonate_bottle_salinity_meta.csv")
