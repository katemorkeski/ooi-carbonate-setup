...
log_url <-("https://rawdata.oceanobservatories.org/files/cruise_data/Irminger_Sea/Irminger_Sea-10_AR76-03_2023-08-27/Water_Sampling/Irminger_Sea-10_AR76-03_CTD_Sampling_Log_2023-10-13_Ver_1-00.xlsx")   

# Irminger 10 salinity data Version 1-00
sal_url <- ("https://rawdata.oceanobservatories.org/files/cruise_data/Irminger_Sea/Irminger_Sea-10_AR76-03_2023-08-27/Water_Sampling/Irminger_Sea-10_AR76-03_Salinity_Sample_Data_2023-10-04_Ver_1-00.xlsx")
...
log_irm10 <- bottles_sal

log_irm080910 <- rbind(log_irm8, log_irm9, log_irm10)
write_csv(log_irm080910, "Irminger_08_09_10_carbonate_bottle_metadata.csv")
